...
const reasons = [
  ...
  },
  {
    ...
    description:
      "Simple, elegant design that focuses on what matters - organizing your code snippets beautifully.",
  },
  {
    icon: Zap,
    title: "Fast & Efficient",
    description:
      "No more wasted time digging through scattered files. Find your code snippets with instant recall.",
  },
  {
    icon: Heart,
    title: "Personal Snippet Vault",
    description:
      "Your own dedicated space for code snippets, organized exactly the way you want it.",
  },
];
      ...
      <div className='container mx-auto px-6 relative'>
        <div className='mx-auto max-w-3xl text-center mb-20'>
          ...
          <p className='text-xl text-gray-400 leading-relaxed'>
            CodeCrate understands how solo developers work and what they need
            from a code snippet manager.
          </p>
        </div>
