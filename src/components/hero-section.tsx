      ...
      <div className="container relative mx-auto px-6">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto mb-12 max-w-3xl text-xl text-gray-300 sm:text-2xl leading-relaxed">
            Your clean, personal snippet vault with tags, folders, and instant recall. Built for solo developers who
            want their code organized beautifully.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {[
              { icon: Search, title: "Fast Search", desc: "Find any snippet with instant recall" },
              { icon: Tag, title: "Smart Tagging", desc: "Organize across projects with tags" },
              { icon: Folder, title: "Clean Folders", desc: "Personal vault structure that works" },
            ].map((feature, index) => (
              <div
                key={index}
