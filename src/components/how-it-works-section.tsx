...
const steps = [
  {
    ...
    description: "Add your code snippets to CodeCrate with a clean, simple interface designed for developers.",
  },
  {
    icon: Tag,
    step: "02",
    title: "Tag & Organize",
    description: "Use tags and folders to organize your snippets across projects. Create your personal system.",
  },
  {
    icon: Search,
    step: "03",
    title: "Search & Find",
    description: "Use fast search to find any snippet instantly. No more digging through scattered files.",
  },
  {
    icon: Folder,
    step: "04",
    title: "Instant Recall",
    description: "Access your organized code snippets with instant recall whenever you need them.",
  },
]
      ...
      <div className="container mx-auto px-6 relative">
        <div className="mx-auto max-w-3xl text-center mb-20">
          ...
          <p className="text-xl text-gray-400 leading-relaxed">
            CodeCrate works the way you think. Save, organize, search, and recall your code snippets effortlessly.
          </p>
        </div>
