...
const features = [
...

  {
    ...
    description:
      "No more digging through files. Access your code snippets with instant recall when you need them.",
  ...
  },
  {
    ...
    description:
      "Built specifically for solo developers who want a clean, personal snippet management solution.",
  ...
  },
  {
    ...
    description:
      "Save and organize code snippets across all your projects in one centralized, searchable location.",
  ...
  },
  {
    ...
    description:
      "Stop using Notion, Gists, or text files. Keep everything organized in your dedicated snippet vault.",
      ...
      <div className='container mx-auto px-6 relative'>
        <div className='mx-auto max-w-3xl text-center mb-20'>
          ...
          <p className='text-xl text-gray-400 leading-relaxed'>
            Simple, elegant, and purposeful. Built for developers who want their
            code organized beautifully.
          </p>
        </div>
